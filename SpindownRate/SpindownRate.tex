...
\FigureAndTable{nu_dot_no_torque}{nu_dot no torque}{ Modulations in the
    ...
    modulations due to free-precession as given by equation \eqref{eqn:
...
toque as calculated from equation \eqref{eqn: spin-down initial EM chi}; the
blue region indicates the modulation about the average spin-down due to
precession from equation \eqref{eqn: spin-down variations FP} while the green
region indicates the modulation about as calculated from equation \eqref{eqn:
spin-down variations FP EM}.}
...
\FigureAndTable{DoublePeaked_LowAem}{Double peaked low Aem}{}

\subsubsection{Intermediate Regime}
\FigureAndTable{DoublePeaked_IntAem}{Double peaked Int Aem}{}
...
\FigureAndTable{DoublePeaked_HighAem}{Double peaked high Aem}{}
