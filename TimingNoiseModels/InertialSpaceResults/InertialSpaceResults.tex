...
\centering
	...
	\subfloat[Variations in polar angle]{\includegraphics[width=0.7\textwidth]{polar_angle_variation_with_chi.pdf}}
\caption{}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.5\textwidth]{amplitude_variation}
\caption{}
