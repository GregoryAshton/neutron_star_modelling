...
#			w2 = pow(omega_x[i],2)+pow(omega_y[i],2)+pow(omega_z[i],2)
#			omega_x_normalised.append(omega_x[i]/w2)
#			omega_y_normalised.append(omega_y[i]/w2)
#			omega_z_normalised.append(omega_z[i]/w2)
#		
#		ax.plot(omega_x_normalised, omega_y_normalised, omega_z_normalised, color="r")
