...
\subfloat[Spherical components in the body frame]
         ...
         {{Spherical_Plot_SpindownTorqueSwitching_1_chi0_8.0000000000e+01_omega0_1.00e+01_epsI3_1.00e-03_AnomTorqueSwitching_1_n_10000_a0_1.5000000000e+01_T_5.00e+03_upsilon_0.00e+00_epsA_0.00e+00_epsI1_0.00e+00_AnomTorque_1}.pdf}} \\
\subfloat[Euler angles ]
         {\includegraphics[width=0.7\textwidth]
         {{Euler_Angles_SpindownTorqueSwitching_1_chi0_8.0000000000e+01_omega0_1.00e+01_epsI3_1.00e-03_AnomTorqueSwitching_1_n_10000_a0_1.5000000000e+01_T_5.00e+03_upsilon_0.00e+00_epsA_0.00e+00_epsI1_0.00e+00_AnomTorque_1}.pdf}}
...
\begin{figure}[ht]
\centering
	\includegraphics[width=0.9\textwidth]{Spindown_no_torque.pdf}
...
In figure \ref{fig: amplitude_variation} an illustration is given of variations 
...
equation \eqref{eqn: amplitude variation}.
...
The pulse width is measured by the time spent about some fractional amount $p$
of the full pulse amplitude. The condition for when the beam width is greater
than this fraction is
\begin{align}
A(\Phi, \Theta, \ThetaO, \PhiO, \sigmaB) > A_{0} \frac{1}{p}.
\end{align}
Substituting equation \eqref{eqn: amplitude variatiion} and rearranging yeilds
\begin{equation}
\cos(\Phi - \PhiO) > \frac{\cos\left(\sqrt{2\sigmaB^{2} \ln(p)}\right) - \sin(\Theta)\sin(\Theta)}
...
$\Phi - \PhiO$ increase beween $-\pi$ and $\pi$ during this rotation.

\begin{figure}[ht]
\centering
\includegraphics[width=.5\textwidth]{CosineIllustration.pdf}
\caption{Illustration of the inequality in equation \eqref{eqn: 6737}, the 
         shaded region indicated when the inequality is satisfied.}
\label{fig: PulseWidthModulation}
\end{figure}•


a single rotation of the star, this condition will be satisfied at two times 
