...
#			back_z.append(z[i])
	...
	def angle_between_vectors(a,b):
		""" Returns angle between a and b which can be either list [a1,a2,a3] or numpy arrays """
		angle = py.arccos(sum(py.array(a)*py.array(b))/(py.norm(a)*py.norm(b)))*180/py.pi
		return angle
