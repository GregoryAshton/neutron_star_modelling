...
cdef int funcs (double t, double w[], double f[], void *params) nogil:
    ...
    AnomTorqueSwitching = (<double *> params)[6]
    SpindownTorqueSwitching = (<double *> params)[7]
...
def main (epsI1=0.0, epsI3=1.0e-6, epsA=1.0e-8 , omega0=1.0e1, chi0=30.0,
    ...
    cleanup=False, AnomTorqueSwitching=True, SpindownTorqueSwitching=True,
    DryRun=False):
   ...
   # Convert python Bool to int
    ...
    params[4] = AnomTorque
    params[5] = upsilon
    params[6] = AnomTorqueSwitching
    params[7] = SpindownTorqueSwitching
